...
var rootCmd = &cobra.Command{
	Use:   "tfauto",
	Short: "Automate Terraform workflows with guardrails",
	Long:  "tfauto standardizes Terraform workflows with safe command wrappers, reusable templates, and consistent project setup.",
